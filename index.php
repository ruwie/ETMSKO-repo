...
<body>
    ...
    <div class="row">
        <div class="col-md-4" id="home-page">
            ...
            <br>
            <a href="user_login.php" class="btn btn-warning " style="margin-right: 20px;">User login</a>
            <a href="user_registration.php" class="btn btn-success" style="margin-right: 20px;">User registration</a>
